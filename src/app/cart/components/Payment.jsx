...
function Payment() {
    return (
        <div className="shadow-gray-500 dark:shadow-gray-900  shadow-lg p-4 rounded-md lg:flex lg:items-start lg:gap-12 xl:gap-16">
            <div className="min-w-0 flex-1 space-y-8">
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" id="your_name" className="block w-full rounded-lg border border-gray-400 bg-gray-50 p-2.5 text-sm dark:text-white dark:bg-zinc-950 dark:border-zinc-800 text-gray-900 focus:border-primary-500 focus:ring-primary-500 " placeholder="Bonnie Green" required />
                        </div>

                        <div>
                            <label htmlFor="your_email" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Your email* </label>
                            <input type="email" id="your_email" className="block w-full rounded-lg border border-gray-400 bg-gray-50 p-2.5 text-sm dark:text-white dark:bg-zinc-950 dark:border-zinc-800 text-gray-900 focus:border-primary-500 focus:ring-primary-500 " placeholder="name@.com" required />
                        </div>
                        ...
                        <div>
                            ...
                            <select defaultValue="AS" id="select-country-input-3" className="block w-full rounded-lg border border-gray-400 bg-gray-50 p-2.5 text-sm dark:text-white dark:bg-zinc-950 dark:border-zinc-800 text-gray-900 focus:border-primary-500 focus:ring-primary-500">
                        ...
                        <div>
                            ...
                            <select defaultValue="NY" id="select-city-input-3" className="block w-full rounded-lg border border-gray-400 bg-gray-50 p-2.5 text-sm dark:text-white dark:bg-zinc-950 dark:border-zinc-800 text-gray-900 focus:border-primary-500 focus:ring-primary-500 ">
                        ...
                        <div>
                            ...
                            <input type="number" id="phone-input-3" className="block w-full rounded-lg border border-gray-400 bg-gray-50 p-2.5 text-sm dark:text-white dark:bg-zinc-950 dark:border-zinc-800 text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="Phone Number" required />

                        </div>

                        <div>
                            <label htmlFor="email" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Email </label>
                            <input type="email" id="email" className="block w-full rounded-lg border border-gray-400 bg-gray-50 p-2.5 text-sm dark:text-white dark:bg-zinc-950 dark:border-zinc-800 text-gray-900 focus:border-primary-500 focus:ring-primary-500 " placeholder="name@.com" required />
                        </div>

                        <div>
                            <label htmlFor="company_name" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Company name </label>
                            <input type="text" id="company_name" className="block w-full rounded-lg border border-gray-400 bg-gray-50 p-2.5 text-sm dark:text-white dark:bg-zinc-950 dark:border-zinc-800 text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="LLC" required />
                        </div>

                        <div>
                            <label htmlFor="vat_number" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> VAT number </label>
                            <input type="text" id="vat_number" className="block w-full rounded-lg border border-gray-400 bg-gray-50 p-2.5 text-sm dark:text-white dark:bg-zinc-950 dark:border-zinc-800 text-gray-900 focus:border-primary-500 focus:ring-primary-500  " placeholder="DE42313253" required />
                        </div>

                        <div className="sm:col-span-2">
                            <label htmlFor="address" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Address  </label>
                            <input type="text" id="address" className="block w-full rounded-lg border border-gray-400 bg-gray-50 p-2.5 text-sm dark:text-white dark:bg-zinc-950 dark:border-zinc-800 text-gray-900 focus:border-primary-500 focus:ring-primary-500  " placeholder="your address" required />
                        </div>
                    </div>
                </div>
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                        <div className="rounded-lg border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-cardDark p-4 ps-4 ">
                ...
                <div>
                    ...
                    <div className="flex max-w-md items-center gap-4">
                        <input type="text" id="voucher" className="block w-full rounded-lg border border-gray-400 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-950 dark:text-white p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="" required />
                    </div>
                </div>
            </div>
