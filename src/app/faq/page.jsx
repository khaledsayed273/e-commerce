      ...
      <div className="container mx-auto px-3 md:px-6 font-sans">
        ...
        <div className="space-y-8 max-w-4xl">
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="md:text-lg font-semibold text-gray-800">How can I track my order?</h3>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="md:text-lg font-semibold text-gray-800">What is the return policy?</h3>
              <p className="text-sm text-gray-600 mt-4">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="md:text-lg font-semibold text-gray-800">Do you ship internationally?</h3>
              <p className="text-sm text-gray-600 mt-4">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="md:text-lg font-semibold text-gray-800">How can I contact customer support?</h3>
              <p className="text-sm text-gray-600 mt-4">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="md:text-lg font-semibold text-gray-800">Can I change my order after placing it?</h3>
              <p className="text-sm text-gray-600 mt-4">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="md:text-lg font-semibold text-gray-800">What payment methods do you accept?</h3>
              <p className="text-sm text-gray-600 mt-4">
