...
const StatsSection = () => {
    ...
    return (
        <div
            ref={sectionRef}
            className="bg-gray-50 dark:bg-cardDark shadow-md dark:shadow-gray-900  my-10 p-8 min-h-[350px] flex flex-col items-center justify-center font-sans">
            <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-6 max-lg:gap-12">
                <div className="text-center">
                    <h3 className="text-gray-800 dark:text-white text-2xl md:text-4xl font-extrabold">
                        {countStarted && <CountUp start={0} end={17.6} duration={2.5} decimals={1} separator="," />}
                        <span className="text-red1">M+</span>
                    </h3>
                    <p className="text-base dark:text-gray-400 font-bold mt-4">Total Customers</p>
                ...
                <div className="text-center">
                    ...
                    <p className="text-base dark:text-gray-400 font-bold mt-4">Revenue</p>
                    <p className="text-sm text-gray-500 dark:text-white mt-2">
                ...
                <div className="text-center">
                    ...
                    <p className="text-base dark:text-gray-400 font-bold mt-4">Active Products</p>
                    <p className="text-sm text-gray-500 dark:text-white mt-2">
                ...
                <div className="text-center">
                    ...
                    <p className="text-base dark:text-gray-400 font-bold mt-4">Customer Satisfaction</p>
                    <p className="text-sm text-gray-500 dark:text-white mt-2">
