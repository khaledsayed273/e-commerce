        ...
        <div>
            <div className='flex justify-between items-center mb-5'>
                ...
                <div className='flex justify-end '>
                    <button aria-label="prev" className='me-2 hover:opacity-60 border border-black/20 dark:bg-cardDark dark:shadow-sm dark:shadow-gray-800 rounded-full' onClick={() => swiperRef.current?.slidePrev()}>
                    ...
                    <button aria-label="next" className='hover:opacity-60 border border-black/20 dark:bg-cardDark dark:shadow-sm dark:shadow-gray-800 rounded-full' onClick={() => swiperRef.current?.slideNext()}>
                        <svg className='dark:text-white' width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
