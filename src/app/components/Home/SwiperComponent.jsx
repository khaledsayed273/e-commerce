        ...
        <div>
            <div className='flex justify-between items-center mb-5'>
                ...
                <div className='flex justify-end '>
                    <button className='me-2 hover:opacity-60 border border-black/20 rounded-full' onClick={() => swiperRef.current?.slidePrev()}>
                    ...
                    <button className='hover:opacity-60 border border-black/20 rounded-full' onClick={() => swiperRef.current?.slideNext()}>
                        <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="23" cy="23" r="23" fill="#F5F5F5" />
