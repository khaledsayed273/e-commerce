...
function Nav({ categoriesData }) {
    ...
    return (
        <div className='flex mb-7'>
            <ul ref={scrollRef} className='flex border-b transition-all border-gray-500 py-3 overflow-hidden me-3 select-none'>
                <li>
            ...
            <div className='flex items-center'>
                <button aria-label="Prev" onClick={scrollLeft} className={`me-2 py-2 px-2 hover:bg-gray-500/50 ${!canScrollLeft && "opacity-50"}`}>
                ...
                <button aria-label="Next" onClick={scrollRight} className={`rotate-180 py-2 px-2 hover:bg-gray-500/50 ${!canScrollRight && "opacity-50"}`}>
                    <svg width="20" height="20" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M8.04283 2.16797L9.45705 3.58218L6.03994 6.99987L9.45705 10.4175L8.04283 11.8318L3.21094 6.99987L8.04283 2.16797Z" fill="currentColor"></path>
                    </svg>
                </button>
