        ...
        <main className="container mx-auto">
            <header className="py-14">
                <div className="px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="max-w-lg mx-auto text-sm text-center md:text-base font-normal leading-7 text-gray-500 md:mb-9">
            ...
            <section >
                <div className="px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="max-w-2xl mx-auto text-center font-manrope font-bold text-2xl text-gray-900 mb-7 md:text-4xl md:leading-normal ">
                        Who we are 
                    </h2>
                    <p className="text-sm md:text-base font-normal leading-7 text-gray-500 mb-12">
